...
public class SwitchTextureBrushItem extends Item {
    ...
    private void addStoredSettingsTooltip(@Nonnull ItemStack stack, @Nonnull List<Component> tooltip) {
        ...
        if (settingsTag != null) {
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.TOGGLE_BLOCK_KEY, "Toggle Block: ", true);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.TOGGLE_FACE_KEY, "Toggle Face: ", false);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.BASE_BLOCK_KEY, "Base Block: ", true);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.BASE_FACE_KEY, "Base Face: ", false);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.TOGGLE_ROTATION_KEY, "Toggle Rotation: ", false);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.BASE_ROTATION_KEY, "Base Rotation: ", false);
            addSettingIfPresent(tooltip, settingsTag, BrushConstants.POWER_MODE_KEY, "Indicators: ", false);
