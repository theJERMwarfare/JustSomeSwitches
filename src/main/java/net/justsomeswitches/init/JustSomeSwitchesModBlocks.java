...
public class JustSomeSwitchesModBlocks {
    ...
    public static final DeferredHolder<Block, BasicTouchBlock> BASIC_TOUCH =
    ...
    /** Basic Touch Inverted block - simple touch switch with inverted visual appearance. */
    public static final DeferredHolder<Block, BasicTouchInvertedBlock> BASIC_TOUCH_INVERTED =
    ...
    public static final DeferredHolder<Item, SwitchBlockItem> SWITCHES_TOUCH_ITEM =
    ...
    public static final DeferredHolder<Item, SwitchTextureBrushItem> SWITCH_TEXTURE_BRUSH =
    ...
    public static final DeferredHolder<Item, BlockItem> BASIC_TOUCH_ITEM =
            ITEMS.register("basic_touch", () -> new BlockItem(
                    BASIC_TOUCH.get(),
                    new Item.Properties()
            ));

    public static final DeferredHolder<Item, BlockItem> BASIC_TOUCH_INVERTED_ITEM =
